...
You may need to change the baud rate back to 19200. I changed it to 9600 so I can route my commands through a TTL UART BLE breakout board device I bought on Amazon:
...
## Credit
I did not create the Alpha Clock Five or the firmware, I am just a contributor. Windell Oskay from Evil Mad Scientist is the creator. https://www.evilmadscientist.com/
